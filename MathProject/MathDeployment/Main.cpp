...
#include <MathProject/MathDeployment/Top/MathDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    MathProject::TopologyState inputs;
    ...
    MathProject::setupTopology(inputs);
    MathProject::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    MathProject::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
